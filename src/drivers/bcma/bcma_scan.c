...
static u32 bcma_scan_read32(struct bcma_bus *bus, u8 current_coreidx __unused,
		       u16 offset)
{
...
static u32 bcma_erom_get_ent(struct bcma_bus *bus __unused, u32 __iomem **eromptr)
{
...
static u32 bcma_erom_get_addr_desc(struct bcma_bus *bus, u32 __iomem **eromptr,
				  u32 type, u8 port)
{
	u32 addrl, addrh __unused, sizel __unused, sizeh __unused = 0;
	u32 size;
