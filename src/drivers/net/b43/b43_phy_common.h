...
struct b43_phy {
	...
	/* Current channel */
	/* ipxe note: Only for the sake of keeping consistent with b43 usage, the
	 * chandef is net80211_channel (although logically doesn't make sense),
	 * and the channel is the chandef->hw_value
	 */
	struct net80211_channel *chandef;
