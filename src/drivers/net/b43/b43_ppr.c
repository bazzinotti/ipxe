...
void b43_ppr_clear(struct b43_wldev *dev __unused, struct b43_ppr *ppr)
{
...
void b43_ppr_add(struct b43_wldev *dev __unused, struct b43_ppr *ppr, int diff)
{
	int i;
	u8 *rate;
...
void b43_ppr_apply_max(struct b43_wldev *dev __unused, struct b43_ppr *ppr, u8 max)
{
	int i;
	u8 *rate;
...
void b43_ppr_apply_min(struct b43_wldev *dev __unused, struct b43_ppr *ppr, u8 min)
{
	int i;
	u8 *rate;
...
u8 b43_ppr_get_max(struct b43_wldev *dev __unused, struct b43_ppr *ppr)
{
	u8 res = 0;
	int i;
	u8 *rate;
