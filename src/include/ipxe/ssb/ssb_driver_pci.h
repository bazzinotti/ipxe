#ifndef IPXE_SSB_PCICORE_H_
#define IPXE_SSB_PCICORE_H_
...
int ssb_pcicore_plat_dev_init(struct pci_device *d);
int ssb_pcicore_pcibios_map_irq(const struct pci_device *dev, u8 slot, u8 pin);
